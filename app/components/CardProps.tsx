...
const CardProps: React.FC<CardProps> = ({ country }) => {
  return (
    <div className="card border w-[250px] mt-5 rounded-2xl flex flex-col gap-y-2 pb-2 ">
      ...
      <p className='text-sm px-2'><strong>Population:</strong> {country.population.toLocaleString()}</p>
